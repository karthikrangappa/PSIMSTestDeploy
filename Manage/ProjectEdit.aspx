    ...
    <div id="contentinner" class="base1">
        ...
        <div class="body">
            ...
            <table align="center" class="editsection" cellspacing="0" role="presentation">
                <tr>
                    <td>
                        <span class="m">*</span><asp:Label ID="lblName" runat="server" Text="<%$Resources:Strings, ProjectName %>"
                            AssociatedControlID="txtName"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtName" runat="server" MaxLength="100" CssClass="fld"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="valName" runat="server" ErrorMessage="" Display="Dynamic" ControlToValidate="txtName"></asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="valDupName" runat="server" Display="Dynamic" OnServerValidate="ValidateName" CssClass="wrn"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblProjectType" runat="server" Text="<%$Resources:Strings, ProjectType %>"></asp:Label>
                    </td>
                    <td>
