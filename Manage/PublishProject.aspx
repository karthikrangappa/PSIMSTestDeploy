...
<%@ Register Assembly="Skinning" NameSpace="SkinControl" TagPrefix ="control1" %>
                ...
                <tr>
                    <td colspan="2">
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <div><asp:CheckBox ID="chkTroubleshooting" runat="server" Text="<%$Resources:Strings, TroubleshootingMode %>"
                                            Checked="false" ToolTip="<%$Resources:Strings, TroubleshootingModeTooltip %>" /></div>
                        ...
                        <div id="pageSkinSettings" class="tabPage" style="display: none" runat="server" clientidmode="static">
                            <control1:SkinSettingsForm ID="projectSkin" runat="server" />
                        </div>
                    </td>
                </tr>
            </table>
